...
public class ResourceHttpRequestHandler extends WebContentGenerator implements HttpRequestHandler, InitializingBean {
    ...
    public ResourceHttpRequestHandler() {
        super(METHOD_POST, METHOD_GET, METHOD_HEAD);
    }
     ...
     * @throws java.io.IOException in case of errors while setting the headers
     */
     ...
     * @param response current servlet response
     * @param resource the identified resource (never {@code null})
     * @throws java.io.IOException in case of errors while writing the content
     */
